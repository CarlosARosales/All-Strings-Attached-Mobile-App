  ...
  public UpdateDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUpdateEntity = new EntityInsertionAdapter<UpdateEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, UpdateEntity value) {
        ...
        final String _tmp_2;
        _tmp_2 = Converters.jsonObjectToString(value.manifest);
        if (_tmp_2 == null) {
          stmt.bindNull(6);
        } else {
        ...
        final Long _tmp_5;
        _tmp_5 = Converters.dateToLong(value.lastAccessed);
        if (_tmp_5 == null) {
          stmt.bindNull(9);
        } else {
    ...
    this.__updateAdapterOfUpdateEntity = new EntityDeletionOrUpdateAdapter<UpdateEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, UpdateEntity value) {
        ...
        final byte[] _tmp_6;
        _tmp_6 = Converters.uuidToBytes(value.id);
        if (_tmp_6 == null) {
          stmt.bindNull(10);
        } else {
          stmt.bindBlob(10, _tmp_6);
        }
      }
    };
  ...
  public List<UpdateEntity> _loadUpdatesForProjectWithStatuses(final String scopeKey,
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item_1.manifest = Converters.stringToJsonObject(_tmp_3);
        final int _tmp_4;
        ...
        _item_1.lastAccessed = Converters.longToDate(_tmp_6);
        _result.add(_item_1);
      }
      return _result;
    } finally {
  ...
  public List<UpdateEntity> _loadUpdatesWithId(final UUID id) {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        final String _tmp_3;
        _tmp_3 = _cursor.getString(_cursorIndexOfManifest);
        _item.manifest = Converters.stringToJsonObject(_tmp_3);
        final int _tmp_4;
        _tmp_4 = _cursor.getInt(_cursorIndexOfStatus);
        ...
        _item.lastAccessed = Converters.longToDate(_tmp_6);
        _result.add(_item);
      }
      return _result;
    } finally {
  ...
  public List<UpdateEntity> loadAllUpdates() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item.manifest = Converters.stringToJsonObject(_tmp_2);
        final int _tmp_3;
        ...
        _item.lastAccessed = Converters.longToDate(_tmp_5);
        _result.add(_item);
      }
      return _result;
    } finally {
